...
import { fetchProductsByFiltersAsync,fetchAllProductsAsync,selectAllProducts, selecttotalItems } from "../productSlice";
    ...
    <div>
      <div>
        <div className="bg-white">
          ...
          <MobileFilter handlefilters={handlefilters} mobileFiltersOpen={mobileFiltersOpen} setMobileFiltersOpen={setMobileFiltersOpen}/>
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                  {/* Filters */}
                 <DesktopFilter handlefilters={handlefilters}/>
                  {/* Product grid */}
...
function MobileFilter({handlefilters,mobileFiltersOpen,setMobileFiltersOpen}) {
...
function DesktopFilter({handlefilters}) {
  return (
    <div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      {Array.from({length:Math.ceil(totalITems/ITEMS_PER_PAGE)}).map((el,index)=>(
                       ...
                       px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 
